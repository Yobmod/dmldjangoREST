...
# import json
import twitter
# from watson_developer_cloud import PersonalityInsightsV2 as PI
...
for status in statuses:
    if (status.lang == 'en'):  # English tweets
        ...
        print(text)
    # when the tweet was created, how many people "favorited" it,
    # what hashtags were used, what other Twitter users were mentioned,
    # what language the tweet is in, and the actual text of the tweet
